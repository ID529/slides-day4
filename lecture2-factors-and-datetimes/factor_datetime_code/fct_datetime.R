...
# The following script pairs with the lecture slides from the January 2024 ID529
# lecture on date-times and factors
#
# ?? amandabhernandez [at] gmail [dot] com
...
library(pacman)
p_load(tidyverse, palmerpenguins, lubridate, parsedate, ID529data)
...
ggplot(nhanes_id529, aes(x = age_quartiles, y = mean_BP)) +
  geom_boxplot()
# note the warning you get from this chunk of code! it's letting you know that
# you used an integer with a boxplot
...
# Note the message: Error: Incompatible classes: <Period> + <Duration>

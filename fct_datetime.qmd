...
<br>
Special thanks to Amanda Hernandez for the original version of this presentation!

<hr>

<br>

Thursday, January 16<sup>th</sup>, 2025
...
as_date(44211, origin = "1904-01-01")
...
class_length <- ymd_hms("2025-01-16 17:30:00") -  ymd_hms("2025-01-16 13:30:00")
class_length
```
...
class_dates <- c(seq(ymd('2025-01-13'),ymd('2025-01-17'), by = 1),
                 seq(ymd('2025-01-21'),ymd('2025-01-24'), by = 1))
class_dates
...
ymd("2025-01-22") %within% class_date_interval
...
interval(start = now(), 
         end = ymd_hms("2025-01-16 17:30:00", 
                       tz = "EST"))
```
...
as_datetime(ymd_hms("2025-03-09 13:30:00")) + dhours(24)
ymd_hms("2025-03-09 13:30:00") + days(1)
...
::: columns
::: {.column width="70%"}
On the first day of ID529 in January 2023, Amanda set up an instrument to log indoor temperature, relative

---
title: "<span style='color: white'>Mapping in R</span>"
format:
  revealjs:
    theme: [default, mapping.scss]
slide-number: true
title-slide-attributes:
  data-background-image: "https://github.com/ID529/lectures/blob/main/graphics/transition_slides/annie-spratt-2.jpg?raw=true"
...
## morals {data-background-image="https://github.com/ID529/lectures/blob/main/graphics/transition_slides/annie-spratt-2.jpg?raw=true" data-background-opacity="60%" data-background-color="black"}
...
# getting data {data-background-image="https://github.com/ID529/lectures/blob/main/graphics/transition_slides/annie-spratt-2.jpg?raw=true" data-background-opacity="60%" data-background-color="black"}
...
## takeaways {.small data-background-image="https://github.com/ID529/lectures/blob/main/graphics/transition_slides/annie-spratt-2.jpg?raw=true" data-background-opacity="60%" data-background-color="black"}
